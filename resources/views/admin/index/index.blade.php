...
<div class="menu_dropdown bk_2">
	...
	@foreach($level_A as $v)
		<dl id="menu-article">
			<dt><i class="Hui-iconfont">&#xe616;</i> {{$v->priv_name}}<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					@foreach($level_B as $vv)
						@if($vv->parent_id==$v->id)
						<li><a data-href="{{url($vv->address)}}" data-title="{{$vv->priv_name}}" href="javascript:void(0)">{{$vv->priv_name}}</a></li>
						@endif
					@endforeach()
				</ul>
			</dd>
