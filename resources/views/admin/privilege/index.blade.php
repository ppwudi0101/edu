	...
	<table class="table table-border table-bordered table-bg">
		<thead>
			...
			<tr class="text-c">
				...
				<th width="100">权限级别</th>
				<th width="100">权限路由</th>
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td>{{$p['id']}}</td>
				<td style="text-align: left">{{str_repeat("--",$p["level_name"])}}{{$p['priv_name']}}</td>
				<td>{{$p['controller_name']}}</td>
				<td>{{$p['action_name']}}</td>
				<td>{{$p['level_name']}}</td>
				<td>{{$p['address']}}</td>
				<td class="td-status"><span class="label label-success radius">已启用</span></td>
				<td class="td-manage"><a style="text-decoration:none" onClick="admin_stop(this,'10001')" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a> <a title="编辑" href="javascript:;" onclick="admin_edit()" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="admin_del(this,'1')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			</tr>
			@endforeach
		</tbody>
	</table>
