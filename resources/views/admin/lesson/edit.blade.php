...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
			<select class="select" name="course_id" size="1">
				...
				@foreach($course as $v)
					<option value="{{$v->id}}" @if($lesson->course_id==$v->id)
							selected="selected"
						@endif>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
					...
					<!-- 显示图片路径 -->
					<input type="text" class="input-text" name="cover_img" id="cover_img" value="{{$lesson->cover_img}}">
					<!-- 进度条显示 -->
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
					<!-- 显示图片路径 -->
					<input type="text" class="input-text" name="video_address" id="video_address" value="{{$lesson->video_address}}">
					<!-- 进度条显示 -->
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9 skin-minimal">
			...
			<div class="radio-box">
				<input name="status" type="radio" id="sex-1" value='1' {{$lesson->status==1?"checked":""}} />
				<label for="sex-1">开启</label>
			</div>
			
			<div class="radio-box">
				<input type="radio" id="sex-2" name="status" value='0' {{$lesson->status==0?"checked":""}}/>
