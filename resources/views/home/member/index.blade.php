    ...
    <header>
        <div class=" learingHeader">
            <nav class="navbar container">
                ...
                <div class="navbar-right"><a href="#">@if(Auth::guard("home")->user()->username!="")
                    用户：{{Auth::guard("home")->user()->username}}
                    @else登录
                    }
                </a><a href="#">注册</a>
                @endif
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img src="../img/widget-bannerA.jpg" alt="AA">
                </div>
                <div class="item">
                    <img src="../img/widget-bannerB.jpg" alt="">
                </div>
            </div>
        ...
        <div class="conten-list">
            <div class="conten" id="a">
                ...
                <div class="row text-center top">
                    <div class="col-lg-3 text-left" id="Title">{{$c->course_name}}</div>
                    <div class="col-lg-5 ">
                        <div class="btn-group btn-group-justified">
                ...
                <div class="container cont-list">
                    <div class="cont-list-roll">
                        ...
                        <div class="cont-list-box">
                            @foreach($c->lesson as $l)
                            <li class="">
                                <img src="../img/page-1.jpg" alt="AA">
                                <div class="tit">{{$l->lesson_name}} <span>高</span></div>
                                <div>武汉大学</div>
                                <div>1门课程</div>
                            </li>
                           @endforeach
    ...
    <div class="container">
        <div class="index-bot-video text-center">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img src="../img/widget-video.jpg" width="500" alt="">
                </div>
            </div>
        </div>
    </div>
