    ...
    <div class="register">
        ...
        <div class="register-body">
            <div class="register-cent">
                ...
                <form action="{{url('login_check')}}" class="required-validate" id="regStudentForm" method='post'>
                {{csrf_field()}}
                        ...
                        <li>
                            <div class="form-group">
                                ...
                                <div class="">
                                    ...
                                    <span class="verif-span1">{{$errors->first("username")}}</span>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="form-group">
                                ...
                                <div class="">
                                    ...
                                    <span class="verif-span1">{{$errors->first("password")}}</span>
                                    <span class="verif-span1">{{$errors->first("errors")}}</span>
                                </div>
                            </div>
                        </li>
                        <li class="">
